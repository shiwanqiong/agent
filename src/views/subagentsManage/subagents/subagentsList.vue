<template>
  <div class="el-university">
    ...
    <div class="hm-btn-panel">
      <router-link :to="{name:''}">
        <el-button type="primary">新增代理商</el-button>
      </router-link>
    </div>
    ...
    data() {
      return {
        ...
        column:[
          ...
          {label:'所在地区',minWidth:'100',prop:'clazz',formatter:this._classFormatter},
          {label:'创建日期',width:'120',prop:'week',formatter:this._weekFormatter},
        ],
        operation:{
          label:'操作',
          type:[
